...
namespace MathNet.Numerics.Optimization
{
    ...
    public class NullEvaluation : BaseEvaluation
    {
        ...
        {
            _point = new DenseVector(1, point);
            _status = EvaluationStatus.None;
        }
    ...
    public class OneDEvaluationExpander : IEvaluation
    {
        ...
        {
            get { return new DenseVector(1,this.InnerEval.Point); }
        }
        ...
        public Vector<double> Gradient
        {
            get { return new DenseVector(1,this.InnerEval.Derivative); }
        }

        public Matrix<double> Hessian
        {
            get { return new DenseMatrix(1,1,this.InnerEval.SecondDerivative); }
        }
    }
